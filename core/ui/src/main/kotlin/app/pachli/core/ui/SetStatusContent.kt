...
object PreProcessMastodonHtml : AbstractMarkwonPlugin() {
    ...
    override fun processMarkdown(input: String): String {
        ...
        val processed = input
            ...
            // So remove all HTML elements inside fenced blocks.
            //
            // Any literal HTML the user wanted to enter will have "&lt;" as the
            // opening bracket of the start tag, which is converted here.
            .replace(rxCodeBlock) { match ->
                match.value
                    .replace(rxTag, "")
                    .replace("&lt;", "<")
                    .replace("&gt;", ">")
            ...
            // Perform the same change inside literals.
            .replace(rxLiteral) { match ->
                match.value
                    .replace("&lt;", "<")
                    .replace("&gt;", ">")
                    .replace("&amp;", "&")
