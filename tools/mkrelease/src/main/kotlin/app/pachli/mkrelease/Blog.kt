...
{% include playlink.html link="Download Pachli $version from Google Play" app="app.pachli" campaign="release-$version" content="textlink" %}, [F-Droid](https://f-droid.org/en/packages/app.pachli/), or the [GitHub release page](https://github.com/pachli/pachli-android/releases/tag/$versionTag).
        """.trimIndent()
